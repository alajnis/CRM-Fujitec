...
export const StageTooltip: React.FC<StageTooltipProps> = ({ stage, children }) => {
  ...
  return (
    <div className="relative inline-block group">
      ...
      {showTooltip && (
        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-[#2D3436] text-white text-xs rounded-lg whitespace-nowrap shadow-lg z-50 pointer-events-none">
